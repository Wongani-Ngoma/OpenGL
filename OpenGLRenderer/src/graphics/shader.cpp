...
void Shader::generate(const char* vertexShaderPath, const char* fragmentShaderPath) {
    ...
    if (!success) {
        ...
        std::cout << "Error: main in main.cpp :: Failed to link shader program\n" << infoLog << "\n";
    }
...
std::string Shader::loadShaderSrc(const char* filename) {
    ...
    if (file.is_open()) {
        ...
        std::cout << "Error: loadShaderSrc in  shader.cpp :: Could not open file " << filename << "\n";
    }
...
GLuint Shader::compileShader(const char* filepath, GLenum type) {
    ...
    if (!success) {
        ...
        std::cout << "Error: main in shader.cpp :: Failed to compile shader\n" << infoLog << "\n";
    }
